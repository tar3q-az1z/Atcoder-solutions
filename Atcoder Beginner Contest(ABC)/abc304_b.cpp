...
int main(void){
	...
	while(++tcase, t--){
		...
		if(n < 1000) cout << n << ln;
			...
			cout << (n / 10) * 10 << ln; 
		}else if(n < 100000) cout << (n / 100) * 100 << ln;
		else if(n < 1000000) cout << (n / 1000) * 1000 << ln; 
		else if(n < 10000000) cout << (n / 10000) * 10000 << ln; 
		else if(n < 100000000) cout << (n / 100000) * 100000 << ln; 
		else if(n < 1000000000) cout << (n / 1000000) * 1000000 << ln;
	}
	return 0;
}
